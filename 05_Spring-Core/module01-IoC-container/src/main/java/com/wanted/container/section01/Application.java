...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        * comment.
        *  결제 시스템이 있다고 가정을 해본다.
        *  KakaoPay 와 NaverPay 가 있으며 Application 에서는 PaymentService 를 호출 시
        *  결제 플랫폼 객체를 생성해서 결제가 되는 시나리오를 구성해본다.
        * */
        ...
        *  "개방-폐쇄 원칙(OCP) 를 위반하며, 1개의 수정 시 여러 코드 수정이 필요하므로 코드의 우연성이 떨어지게 된다.
