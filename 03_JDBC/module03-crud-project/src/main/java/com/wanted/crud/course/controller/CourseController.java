...
public class CourseController {
    ...
    *  - 2. Service 메서드 호출 코드
    *  - 3. 필요하다면 DTO/객체를 조립하는 코드
    *  - Controller 가 하면 안되는 일
    *  - 1. Scanner 입력처리
    *  - 2. Scanner 출력처리
    *  - 3. SQL 작성
    ...
    * */
    ...
    public boolean createCourseWithDefaultSection() {
        // 강의 객체
        CourseDTO newCourse = new CourseDTO(null, 1L, "Java Transaction Master", "트랜잭션을 활용한 강의 등록", "draft");
        SectionDTO newSection = new SectionDTO(null, null, "Chapter1. 트랜젝션의 이해",1);
