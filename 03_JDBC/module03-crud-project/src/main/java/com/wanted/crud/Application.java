...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        try (Connection con = JDBCTemplate.getConnection()) {
            ...
            *  -> CourseDAO -> MySQL(DBMS)
            *  response 시
            *  MySQL(DBMS) -> CourseDAO -> CourseService -> CourseController
            *  -> CourseOutputView -> Application
            *  역순이다. 다만 CourseOutputView 를 통해 결과물을 보여줄 것이다.
             * */

            /**
             * 문서화 주석
             * @deprecated 현재 아래에 작성 될 코드는 나중에는 사라진다는 코드
             * 객체 조립 진행
             * */
            ...
            /* Application 이 실행되면 View 메소드 실행한다. */
