...
import com.wanted.springevent.section01.service.Section01CourseCompletionService;
...
@Component
// jj) application run 대신 DemoRunner 수행
public class DemoRunner implements ApplicationRunner {

    private static final
    Logger log = LoggerFactory.getLogger(DemoRunner.class);
