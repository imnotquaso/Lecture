...
public class Section02CourseCompletionService {
    ...
    *  직접 비지니스 로직으로 관리하는 것이 아닌 "수강 완료가 발생했다" 라는
    *  사실만 이벤트로 발생시킬 것이다.
    *  ----
    *  [중요한 점]
    ...
    * */
    // jj) 수강완료는 직접 의존성 주입, 수료증 발급은 certificate 내에서 발생시킴
    // jj) 중요도를 파악해서 적절히 의존성/이벤트로 나눈다.
    ...
    public void completeCourse(Long enrollmentId) {
        ...
        log.info("[section02] Course 서비스는 수강 완료 처리 후 이벤트만 발생한다.");
