package com.wanted.oop.polymorphism.a_polymorphism;
...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *  그렇기 때문에 하나의 타입으로 여러 타입의 인스턴스를 처리할 수 있고 하나의 메소드 호출로 객체별 다른 방법으로 돈작하게 할 수 있다.
        * */
        ...
        /*
        * comment. 동적 바인딩
        *  컴파일 시점에는 해당 타입의 메소드와 연결 되어 있다가 런타임 시점에 실제 객체가 가진 오버라이딩 된 메소드 (koala, Raccoon)로
        *  변경되어 동작하는 것을 의미한다.
        * */
