...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        /*
         * comment. 중요!! heap공간은 값이 비어있을 수 없다.
         *  그러나 우리는 값을 넣은 적이 없는데 0이라는 값이 출력되었다.
         *  그렇다는 것은 각 자료형 별 기본 값으로 세팅이 된다 라는 것이다.
         *  -----------------------------------------------------
         *  정수 : 0
         *  실수 : 0.0
         *  논리 : false
        ...
        System.out.println("NullPointerException 발생 :" + sarr[4].length()); // sarr[4] = null, null.lenghth(); = 오류
        // . : 참조 연산자 // 참조 연산자, 대입 연산자, 할당 연산자
