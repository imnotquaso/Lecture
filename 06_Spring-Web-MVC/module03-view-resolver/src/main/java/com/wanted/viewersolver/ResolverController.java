...
public class ResolverController {
    ...
    @GetMapping("string")
    // HttpResponse -> model, HttpRequest -> @RequestParam, @ModelAttribute
    public String stringView(Model model) {
        ...
        /*
        * comment.
        *  @Controller 에서 문자열 리턴의 의미는 반환 후 ThymeleafViewResolver 에게
        *  resources/templates/ 를 prefix 로, .html 을 suffix 로 하겠다는 의미이다.
        *  아래 리턴값은 실제로 resources/templates/result.html 이 의미로 해석된다.
        * */
    ...
    public String stringRedirect() {
        ...
        *  redirect 가 핗요하면, 접두사 redirect:{보낼 url}
        *  이렇게 작성을 해주면 된다.
        * */
    ...
    public String stringRedirectAttr (RedirectAttributes rttr) {
        ...
        *  그렇기 떄문에 최초에 model 에 담아둔 test 값은 재요청시 소멸된다.
        *  우리는 redirect 시 저장한 값을 응답하기 위해서 session, cookie 개념을 배웠었다.
        *  spring 에서는 RedirectAttributes 라는 타입을 통해 redirect 를 하더라도 값을 저장할 수 있는 방법을 제공해준다.
        * */
...
//        model.addAttribute("test", "test");
        ...
        /*
        * comment.
        *  세션에 입시로 값을 담아두고, 자동 고멸하는 방식이기 떄문에
    ...
    *  3. ModelAndView -> setViewName(문자열) 문자열 view 경로가 됨
    * */
