...
*  이 Servlet 은 Http 요청을 받는 즉시 @Controller 어노테이션이 달린 클래스에 처리를 위임한다.
* */
...
public class MethodMappingController {
    ...
    * */
    ...
    public String registMenu(Model model) {
        ...
        /*
        * model 객체란?
        * model 객체는 server 에서 발생한 값을 담을 수 있는 객체이다.
        * key-value 형태로 값을 담게 되며, 응답 시 view 에서 Model 에 담긴 값을 사용할 수 있게 된다.
        ...
        *  메소드의 반환타입을 String 으로 한 후,
        *  문자열을 return 하면 resources/templates 하위 경로의 파일을 탐색한다.
        * */
