...
public class CalculatorController {
     ...
     * 계산기 서비스 의존성 주입
     *
     * Spring 의 의존성 주입(DI)을 통해 CalculatorService 를 주입받는다.
     * @Autowired 어노테이션을 사용하여 자동으로 Bean 을 주입한다.
     *
     ...
     *
     * Spring Actuator 와 별도로 커스텀 헬스체크를 제공한다.
    ...
    public static class CalculationResult {
        ...
        /* 설명. Getter 메서드들이다. Jackson 이 JSON 직렬화 시 이 메서드들을 사용한다. */
