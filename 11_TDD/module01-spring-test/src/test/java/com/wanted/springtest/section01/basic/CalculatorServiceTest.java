...
@SpringBootTest
@ActiveProfiles("test") // test config 등록은 java 의 TestConfig 에서, 활성은                                                                                                                                                                                                                                  에서.
public class CalculatorServiceTest {

    /*
    * comment.
    *  @ActiveProfiles("test") 어노테이션을 인해
    *  TestConfig 클래스에 정의한 testCalculatorService() Bean 이 주입된다.
    * */
    ...
    /*
    * comment.
    *  Service 계층 테스트는 실제 비지니스 로직의 동작을 확인하는 용도로 사용된다.
