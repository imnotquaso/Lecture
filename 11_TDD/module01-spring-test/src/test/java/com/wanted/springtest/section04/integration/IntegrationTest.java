...
public class IntegrationTest {
    ...
    void setUp() {
        ...
        // 지금은 학습 편의상 Bean 으로 등록하지 않았기 때문에 mock 객체로 만든다.
    ...
    void 이메일_중복_시_예외_발생_테스트() {
        ...
        // Service 에서 Throw 한 예외 발행하는 지 Test
    ...
    void 유효한_ID로_사용자_조회_테스트() {
        ...
        // expect
        // Optional.of() : 사용자가 존재할 때, 실제 객체 확인
        // Optional.empty() : 사용자가 없을 때, 시스템이 NullPointException 없이 안전하게 작동하는지 확인
