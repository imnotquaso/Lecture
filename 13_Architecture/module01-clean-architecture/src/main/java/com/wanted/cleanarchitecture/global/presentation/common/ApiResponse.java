package com.wanted.cleanarchitecture.global.presentation.common;
...
public record ApiResponse <T> (
    ...
    *  Instant -> Java 시간 관련 클래스.
    *  해당 클래스는 시간 뿐만 아니라 지역도 나오기 때문에 글로벌 서비스에서 많이 쓰인다.
    * */
    ...
    // 생성과 일반 성공을 분리해두면 controller 가 REST 의도를 더 명확히 표현할 수 있다.
