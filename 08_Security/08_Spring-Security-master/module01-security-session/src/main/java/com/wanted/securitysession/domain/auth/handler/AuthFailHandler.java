 ...
 * 우리는 AuthenticationFailureHandler 를 구현해야 하지만 기존에 구현이 되어있는
 * SimpleUrlAuthenticationFailureHandler 를 상속받아
...
public class AuthFailHandler extends SimpleUrlAuthenticationFailureHandler {
    ...
    private final LoginLogRepository loginLogRepository; // service 들렸다가 repository 부르기
