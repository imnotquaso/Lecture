...
public class AuthDetails implements UserDetails {
    ...
    /**
     * 권한 정보를 반환하는 메서드이다.
     * UsernamePasswordAuthenticationToken 에 사용자의 권한 정보를 넣을 때 사용된다.
     * */
    @Override
     ...
     *
     * 왜 필요한가?
     * Spring Security 의 SessionRegistry 는 내부적으로 Map 형태로 사용자를 관리한다.
     * 이때 key 로 principal(AuthDetails 객체)이 사용되며,
     ...
     * 결과:
     * - 같은 사용자라도 여러 명으로 인식됨
     * - SessionRegistry 에서 활성 사용자 수가 실제보다 많게 나올 수 있음
     *
     * 해결 방법:
     ...
     * - SessionRegistry 도 내부적으로 Map 구조를 사용하기 때문에 hashCode 가 중요하다.
     *
     * 규칙:
     * - equals()에서 사용한 기준과 동일한 기준으로 hashCode 를 생성해야 한다.
     *
     * 잘못된 경우:
     * - equals 는 userId 기준인데 hashCode 는 DTO 전체 기준이면
     *   같은 사용자라도 다른 hashCode 가 나올 수 있음 → 버그 발생
     *
     * 따라서:
