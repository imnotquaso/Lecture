...
-- 1. SQL 기초 강의 기초 수강생들의 평균 점수 구하기 ex) 평균 85
...
-- 'Python' 태그가 붙은 과정을 수강 신청한 모든 학생의 user_id 와 name, courses_id 조회하라.
-- enrollments, tags, courses join 이 연산됨
-- 1. 
select 
	u.user_id, 
    u.name,
...
-- 각 교육자 별로 개설한 과정 수를 계산한 결과를 가상 테이블로 만들고.
